...
#                    :default_url => '/images/avatars/default_:style.gif',
                    :path => "/system/avatars/:id/:style/:id.:extension",
                    :url  => "/system/avatars/:id/:style/:id.:extension"
  ...
  has_and_belongs_to_many :announcements, :join_table => "people_announcements"
  has_many :comments
  has_many :tokens
